...
kafka-topics.sh --create --topic bitcoin --bootstrap-server kafka:9092 --partitions 1 --replication-factor 1 --if-not-exists
kafka-topics.sh --create --topic ethereum --bootstrap-server kafka:9092 --partitions 1 --replication-factor 1 --if-not-exists
kafka-topics.sh --create --topic solana --bootstrap-server kafka:9092 --partitions 1 --replication-factor 1 --if-not-exists
